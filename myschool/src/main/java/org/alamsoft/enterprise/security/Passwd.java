...
public class Passwd {
	...
	public static void main(String[] args) {
		 ...
		 * encodedPassword) { // TODO Auto-generated method stub return false; }
		 * 
		 * @Override public String encode(CharSequence rawPassword) { // TODO
		 * Auto-generated method stub return null; } };().encode("test");
